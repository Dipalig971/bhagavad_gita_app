...
## 2. Daily Verse
- Receive a new verse every day as part of your spiritual practice.
- Option to set daily reminders for your verse notifications.

## 3. Share Verses
- Seamlessly share your favorite verses, translations, and commentary using the `share_extend` package.
- Share to WhatsApp, Instagram, Facebook, or any other app directly from the app.

## 4. Copy Verses or Text:
- Users can tap a "Copy" button next to any verse or explanation.
- The selected content is copied to the clipboard, ready to paste anywhere.
